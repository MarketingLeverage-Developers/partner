...
import styles from './MeritWrapper.module.scss';
...
const MeritWrapper = () => {
    return (
        <div className={styles.MeritWrapper}>
            <div className={styles.TextWrapper}>
                <div className={styles.TitleText}>자사 정보 메리트</div>
                <div className={styles.SubTitleText}>파트너 물류와 함께하면 더 좋은 이유</div>
            </div>
            <div className={styles.BackgroundWrapper} style={{ backgroundImage: `url(${MeritBackgroundImage.src})` }}>
